...
<template>
  ...
  <div><a-button @click="onIframePrint('test')">下载页面</a-button></div>
</template>
<style lang="less" scoped>
  .print {
    // 如果使用 html2canvas + jspdf，以下样式会自动生效
    position: absolute;
    top: -9999px;
    left: -9999px;
    padding: 16px 8px;
  ...
  // 如果使用 iframe + window.print，请追加以下所有样式（需要放开 .content { font-size: 14px; }）
  .content {
    // font-size: 14px;
    text-align: center;
  }
